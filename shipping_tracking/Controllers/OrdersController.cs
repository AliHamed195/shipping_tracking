...
namespace shipping_tracking.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,UserID,TotalPrice,OrderStatus,CreatedOn,IsDeleted")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,UserID,TotalPrice,OrderStatus,CreatedOn,IsDeleted")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
